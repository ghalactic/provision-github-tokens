...
<details>
<summary>✅ Repo <a href="https://github.example.com/account-x/repo-x">account-x/repo-x</a> was allowed to provision secret <code>SECRET_B</code></summary>
...
- [`SECRET_B`](#user-content-4bb7e3c2-secret_b) ([account-x/repo-x](https://github.example.com/account-x/repo-x))
