...
- ✅ Can provision token to GitHub Actions secret in account-a:
  - ✅ Account account-a was allowed access to [token #1](#user-content-4bb7e3c2-token-1)
  - ✅ Can provision secret based on 1 rule:
    - ✅ Allowed by rule #1
- ✅ Can provision token to GitHub Actions secret in account-a/repo-a:
  - ✅ Repo account-a/repo-a was allowed access to [token #2](#user-content-4bb7e3c2-token-2)
  - ✅ Can provision secret based on 1 rule:
    - ✅ Allowed by rule #1
