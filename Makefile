GENERATED_FILES += src/schema/generated.requester-token-permissions.v1.schema.json src/schema/generated.provider-rule-permissions.v1.schema.json dist/main.cjs dist/main.cjs.map
...
dist/main.cjs dist/main.cjs.map: script/build.js artifacts/link-dependencies.touch $(JS_SOURCE_FILES)
	node "$<" "$@"
